    ...
    <div class="text-center mb-16">
      ...
      <div class="flex items-center justify-center mt-8 space-x-3">
        <div class="flex space-x-1">
          @for ($i = 1; $i <= 5; $i++)
            <svg class="w-8 h-8 text-white drop-shadow-[0_0_6px_rgba(255,255,255,0.7)]"
        ...
        <span class="text-pink-200">from 150+ reviews</span>
      </div>
    </div>
        ...
        <div class="group">
          <div
            ...
            <div class="flex justify-center space-x-1 mb-6">
              @for ($i = 1; $i <= 5; $i++)
                <svg class="w-5 h-5 {{ $i <= $testimony->rating ? 'text-white drop-shadow-[0_0_6px_rgba(255,255,255,0.7)]' : 'text-white/30' }}"
                  fill="currentColor" viewBox="0 0 20 20">
                  <path
                    d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
