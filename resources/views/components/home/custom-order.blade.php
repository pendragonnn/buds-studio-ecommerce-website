<section id="custom-order"
  class="relative py-16 md:py-24 bg-[linear-gradient(135deg,#ffd8e6,#764ba2)] overflow-hidden">

  <!-- Decorative Background Elements -->
  <div class="absolute inset-0 overflow-hidden pointer-events-none">
    <div class="absolute top-10 right-10 w-32 h-32 md:w-40 md:h-40 bg-pink-200 rounded-full opacity-20 animate-pulse"></div>
    <div class="absolute top-1/3 left-5 w-24 h-24 md:w-32 md:h-32 bg-rose-200 rounded-full opacity-15 animate-bounce"></div>
        ...
        <div class="space-y-4">
          ...
          <div class="bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl p-4 border border-pink-100">
            <div class="flex items-start">
              <div
                class="w-6 h-6 bg-pink-500 rounded-full flex items-center justify-center mr-3 flex-shrink-0 mt-0.5">
          ...
          <div class="bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl p-4 border border-pink-100">
            <div class="flex items-start">
              ...
              <p class="text-gray-700 text-sm md:text-base flex-1">
                Price may vary depending on the <span class="font-semibold text-pink-600">complexity of the design</span>.
              </p>
            </div>
          </div>
